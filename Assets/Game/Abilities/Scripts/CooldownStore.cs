...
namespace RPG.Abilities
{
    public class CooldownStore : MonoBehaviour
    {
        ...
        Dictionary<InventoryItem, float> initialTimers = new Dictionary<InventoryItem, float>();
        ...
        public void StartCooldown(InventoryItem ability, float cooldownTime)
        {
            ...
            initialTimers[ability] = cooldownTime;
        }
        ...
        public float GetFractionRemaining(InventoryItem ability)
        {
            ...
            return cooldownTimers[ability] / initialTimers[ability];
        }

        public bool IsCoolingdown(InventoryItem ability)
        {
            return GetTimeRemaining(ability) != 0;
        }
    }
}